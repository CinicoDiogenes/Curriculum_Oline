<?php
$usuario		= "andrefelipedeoliveira@mataroin365.onmicrosoft.com";
$password		= "CursoSOC2023";

$nombre 		= $_POST['campo_nombre'];
$asunto 		= addslashes($_POST['campo_asunto']);
$email 			= $_POST['campo_email'];
$destinatario	= $_POST['campo_destinatario'];
...
$sk = '6Le4ra8mAAAAAPhMNKVu3_iaNaY5xXeVEijyPcth';
